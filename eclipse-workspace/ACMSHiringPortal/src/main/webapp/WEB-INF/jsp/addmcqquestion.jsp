...
<html>
<head>
<title>Hiring Portal : Add MCQ Question</title>
<style>
body {
	font-family: Arial;
}
	...
	<div class="container1">
		...
		<div class="incontainer">
			<form method="post" id="myForm">
				...
				<fieldset class="form-group">
					<label for="optiona" class="bmd-label-floating">Option A</label> <input
						type="text" class="form-control" id="optiona">
				</fieldset>
				<fieldset class="form-group">
					<label for="optionb" class="bmd-label-floating">Option B</label> <input
						type="text" class="form-control" id="optionb">
				</fieldset>
				<fieldset class="form-group">
					<label for="optionc" class="bmd-label-floating">Option C</label> <input
						type="text" class="form-control" id="optionc">
				</fieldset>
				<fieldset class="form-group">
					<label for="optiond" class="bmd-label-floating">Option D</label> <input
						type="text" class="form-control" id="optiond">
				</fieldset>
				<fieldset class="form-group">
...
<script>
	...
	function formToJSON() {
		...
		var indexCorrectAnswer = document.getElementById("correctanswer");
		var correctanswer = indexCorrectAnswer.options[indexCorrectAnswer.selectedIndex].text;
	...
	var logoutUrl = 'http://localhost:/login'; // URL to logout page.
