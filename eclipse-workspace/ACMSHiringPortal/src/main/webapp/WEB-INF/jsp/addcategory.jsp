...
<html>
<head>
<title>Hiring Portal : Add Category</title>
<style>
body {
	font-family: Arial;
}
...
<body onload="StartTimers(); return loadcorddetails();" onmousemove="ResetTimers();">
	...
	<h2 class="text-center" style="margin-top:20px"><i>Add Category</i></h2>
		<div class="incontainer">
			<form method="post" id="myForm">
				<fieldset class="form-group">
					<label for="categoryname" class="bmd-label-floating">Category
						Name</label> <input type="text" class="form-control" id="categoryname"
						required>
				</fieldset>
				<fieldset class="form-group">
					<label for="type">Choose Type</label> <select id="type">
						<option value="mcq">mcq</option>
						<option value="code" selected="selected">code</option>
					</select>
				</fieldset>
				<input type="button" value="Add Category" id="submit_button"
					onclick="submitForm()">
			</form>
		</div>
	</div>
...
<script>
	...
	function formToJSON() {
		var categoryname = document.getElementById("categoryname").value;
		var indexType = document.getElementById("type");
		var type = indexType.options[indexType.selectedIndex].text;
	...
	var logoutUrl = 'http://localhost:3003/login'; // URL to logout page.
