...
<body onload="StartTimers(); loadcorddetails(); return loadstudents();"
	...
	<div class="container1">
		...
		<fieldset class="form-group">
			<label for="tdate" class="bmd-label-floating">Test Date</label> <input
				type="datetime-local" class="form-control" id="tdate" required>
		</fieldset>
		</md-input-container>
		<fieldset class="form-group">
			<label for="ttimer" class="bmd-label-floating">Test time(in
				minutes)</label> <input type="number" class="form-control" id="ttimer"
				required>
		</fieldset>
		<fieldset class="form-group">
			<label for="testdrop">Test</label> <select id="testdrop">
			</select>
		</fieldset>
		<fieldset class="form-group">
			<label for="subject" class="bmd-label-floating">Email Subject</label>
			<input type="text" class="form-control" id="subject" required>
		</fieldset>
		<fieldset class="form-group">
			<textarea rows="10" cols="74" id="body" placeholder="Email Body"
				required></textarea>
		</fieldset>
...
<script>
	...
	function getTestID() {
		...
		var isvalidate = true;
		var indexTest = document.getElementById("testdrop");
		var test = indexTest.options[indexTest.selectedIndex].text;
		console.log(test);
		if (isvalidate) {
	...
	function formToJSON() {
		...
		var ttimer = document.getElementById("ttimer").value;
