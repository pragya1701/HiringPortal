...
<html>
<head>
<title>Hiring Portal : Dashboard</title>
<style>
body {
	font-family: Arial;
}
...
<body
	...
	<div class="container1">
		<div class="bg-text"
			style="margin-top: 270px; margin-left: -220px; height: 350px; width: 400px">
			<h3>Create Test,Questions and Categories</h3>
			<a href="levels"> <img style="height: 200px; width: 200px"
				src="/images/cordcreate.png" /></a>

		</div>
		<div class="bg-text"
			style="margin-top: 270px; margin-left: 220px; height: 350px; width: 400px">

			<h3>View Test History and User Report</h3>

			<a href="cordhistory"> <img style="height: 200px; width: 200px"
				src="/images/cordhistory.png" />
			</a>
		</div>
	</div>
